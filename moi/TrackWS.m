...
-(void)SubmitTrackLog
{
    ...
    @try {
        ...
        "<soap:Body>";
        //========================parameters========================
        soapBody = [soapBody stringByAppendingString:[NSString stringWithFormat:@"<insertTrackingLog xmlns=\"http://tempuri.org/\">"]];
        ...
        soapBody = [soapBody stringByAppendingString:[NSString stringWithFormat:@"</insertTrackingLog>"]];
        //======================end=parameters======================
        ...
        [request addValue:@"http://tempuri.org/insertTrackingLog" forHTTPHeaderField:@"SOAPAction"];
        ...
        AFXMLRequestOperation *operation = [AFXMLRequestOperation XMLParserRequestOperationWithRequest:request success:^(NSURLRequest *request, NSHTTPURLResponse *response, NSXMLParser *XMLParser) {
            ...
            if (tResponse > 1) {
                UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"حالة التسجيل"
                                                               message:[NSString stringWithFormat:@"تم تسجيل الموقع %i بنجاح",tResponse]
                                                              delegate:nil
